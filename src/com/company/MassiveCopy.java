...
public class MassiveCopy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Массив перед скопированием : " + Arrays.toString(numbers));

        int[] array1 = new int[10];
        int[] array2 = new int[10];

        array1 = copyTheFirsTen(numbers);
        System.out.println("Новый массив с первыми 10 элементами : " + Arrays.toString(array1));

        array2 = copyTheSecondTen(numbers);
        System.out.println("Новый массив со вторыми 0 элементами : " + Arrays.toString(array2));
    }
